...
const a = numbersList1.push(6); // let a = новая длинна массива
console.log(a);
...
const filterRes = anotherNumbersList.filter(function fiterCallback(num) {
  return num > 0;
});
